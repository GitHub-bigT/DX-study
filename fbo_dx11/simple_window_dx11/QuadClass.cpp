...
bool QuadClass::init(ID3D11Device *device)
{
	bool result;
...
bool QuadClass::initQuadBuffer(ID3D11Device *device)
{
	VertexType* vertices;
...
void QuadClass::renderQuadBuffer(ID3D11DeviceContext *deviceContext)
{
	unsigned int stride;
	unsigned int offset;
