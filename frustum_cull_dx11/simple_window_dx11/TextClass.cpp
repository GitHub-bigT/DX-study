...
bool TextClass::init(ID3D11Device* device, ID3D11DeviceContext* deviceContext, HWND hwnd, int screenWidth, int screenHeight)
{
	bool result;
	...
	result = m_fontClass->init(device, deviceContext, "../../source_image/fontdata.txt", L"../../source_image/font.dds");
	if (!result)
	{
